...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("+255656957673")
...
global.gurl = 'MNISI-3694' // add your username
...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? 'MNISI-BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'mnisi3694' : process.env.OWNER_NAME,
...
recordingpresence:  process.env.RECORDING === undefined ? true : process.env.RECORDING,	
  ...
  antilinkaction: process.env.ANTILINK_ACTION === undefined ? 'enable' : process.env.ANTILINK_ACTION,
  BRANCH: 'main', 
